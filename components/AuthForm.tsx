        ...
        <header className="flex flex-col gap-5 md:gap-8">
            <Link href="/" className="cursor-pointer flex items-center gap-1">
                <Image
                    ...
                    alt="Global logo"
                />
                <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">Global</h1>
            </Link> 
                        ...
                        {type === 'sign-up' && (
                            <>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <CustomInput control={form.control} name='id' label="ID" placeholder="Enter your Id No"/>
                                </div>
                            </>
                        )}
